...
class Program {
    private const string API_KEY = "e0336276acd641c19123de5e6918ea64";
    private const string ENDPOINT = "https://aminesopenai.openai.azure.com/openai/deployments/gpt-4/chat/completions?api-version=2024-02-15-preview";
            ...
            messages = new object[]
            {
                new {
                    ...
                    content = new object[] {
                        new {
                            type = "text",
                            text = "You are an expert on comics and your answers only relation in comics and in spanish."
                        }
                    }
                },
                new {
